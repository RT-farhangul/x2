...
<div class="form">
    ...
    <div class="top row">
        <?php echo $form->labelEx($model,'test_field1'); ?>
        <?php echo $form->textArea($model,'test_field1',array('style'=>'width:1000px;height:150px;')); ?>
        <?php echo $form->error($model,'test_field1'); ?>
    </div>
