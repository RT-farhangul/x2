...
class Rec_new_moduleController extends x2base {

    public $modelClass = 'Rec_new_module';
    ...
    public function actionCreate() {
        $model=new Rec_new_module;
        $users=User::getNames();

        if(isset($_POST['Rec_new_module'])) {
            $temp = $model->attributes;
            $model->setX2Fields($_POST['Rec_new_module']);
    ...
    public function actionIndex() {
        $model=new Rec_new_module('search');
    ...
    protected function performAjaxValidation($model) {
        if(isset($_POST['ajax']) && $_POST['ajax']==='rec_new_module-form') {
