...
include("protected/modules/rec_new_module/rec_new_moduleConfig.php");
...
?>
<div class="page-title rec_new_module"><h2><?php echo Yii::t('module','Update {X}',array('{X}'=>Modules::itemDisplayName())); ?> <?php echo $model->name; ?></h2></div>

<?php 
$this->widget ('FormView', array(
	'model' => $model
));
//echo $this->renderPartial('application.components.views.@FORMVIEW', array('model'=>$model,'users'=>$users, 'modelName'=>'rec_new_module')); ?>
