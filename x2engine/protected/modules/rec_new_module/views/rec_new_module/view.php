...
$modelType = json_encode("Rec_new_module");
...
<div class="page-title-fixed-outer">
    <div class="page-title-fixed-inner">
        <div class="page-title rec_new_module">
            <h2>
...
<div id="main-column" <?php echo $layoutManager->columnWidthStyleAttr (1); ?>>
            ...
            //$this->renderPartial('application.components.views.@DETAILVIEW', array('model' => $model, 'modelName' => 'rec_new_module')); ?>
...
$this->widget ('ModelFileUploader', array(
    'associationType' => 'rec_new_module',
